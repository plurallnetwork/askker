...
namespace Askker.App.iOS.PDFComponents
{
    ...
    public class FilePickerImplementation : NSObject, IUIDocumentMenuDelegate, IFilePicker
    {
        ...
        public void DidPickDocumentPicker(UIDocumentMenuViewController documentMenu, UIDocumentPickerViewController documentPicker)
        {
            ...
            this.viewController.PresentViewController(documentPicker, true, null);
        }
        ...
        public async Task<FileData> PickFile(UIViewController viewController)
        {
        ...
        private Task<FileData> TakeMediaAsync()
        {
            ...
            this.viewController.PresentViewController(importMenu, true, null);
            ...
            if (presPopover != null)
            {
                ...
                presPopover.SourceView = this.viewController.View;
