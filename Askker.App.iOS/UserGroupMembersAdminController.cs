...
namespace Askker.App.iOS
{
    public partial class UserGroupMembersAdminController : GroupMemberBaseTableViewController
    {
        ...
        MemberResultsTableController resultsTableController;
        ...
        public override void ViewDidLoad()
        {
            ...
            resultsTableController = new MemberResultsTableController
            {
        ...
        {
            var tableController = (MemberResultsTableController)searchController.SearchResultsController;
    ...
    public class MemberResultsTableController : GroupMemberBaseTableViewController
    {
