            ...
            {                
                ...
                else
                {
                    ...
                    using (NSData imageData = Utils.CompressImage(profileImageView.Image))
                    {
                        ...
                        //SDWebImageManager.SharedManager.ImageCache.StoreImage(profileImageView.Image, EnvironmentConstants.getS3Url() + LoginController.userModel.profilePicturePath);
