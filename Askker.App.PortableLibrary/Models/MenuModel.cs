...
namespace Askker.App.iOS.Models
{
    ...
    public class MenuPagesModel : MenuModel
    {
        ...
        public MenuPagesModel()
        {
            ...
            MenuItems.Add(new MenuModel() { MenuItem = MenuItem.MyGroups, Title = "My Groups", ImageName = "MyGroup" });
            MenuItems.Add(new MenuModel() { MenuItem = MenuItem.SearchGroups, Title = "Find Groups", ImageName = "FindGroup" });
